...
私がやったのは、「日本のAI競争力について、こういう構成で、こういう主張を述べたい」と言葉でAIに指示したことだけだ。データの引用、論理構成、文章表現 — すべてAIが生成した。記事だけではない。同時に公開している[スライド資料](https://stackbeedash.github.io/public-presentation/japan-ai-strategy/)も同様だ。
